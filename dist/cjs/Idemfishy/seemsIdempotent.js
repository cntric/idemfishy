...
exports.seemsIdempotent = void 0;
 ...
 * @returns
 */
const seemsIdempotent = (kwargs) => {
    return _seemsIdempotent(Object.assign(Object.assign({}, kwargs), { width: kwargs.width ? kwargs.width : 100, depth: kwargs.depth ? kwargs.depth : 100, toleranceFunc: kwargs.toleranceFunc ? kwargs.toleranceFunc :
            (a, b) => a === b }));
};
exports.seemsIdempotent = seemsIdempotent;
